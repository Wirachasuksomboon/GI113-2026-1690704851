...
namespace Lab04
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"\n\"Difficulty {difficulty} selected. Good luck out theres");
            ...
            Console.WriteLine($"Vali impunt: {isValid}");
            Console.WriteLine($"Rating: {quantity}");

            Console.WriteLine("+----------------------------+");
            Console.WriteLine("|     CHARACTER CHEATION     |");
            Console.WriteLine("+----------------------------+");
            Console.WriteLine("Name Your character: ");
            String charName = Console.ReadLine();
            Console.Write("Choose a ciass (1-3): ");
            ...
            Console.WriteLine($"\n{charName} the class-{classNum} adventurer enther the dungeon, {luck}");
